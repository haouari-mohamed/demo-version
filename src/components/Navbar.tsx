          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <div className="relative group">
              ...
              <div className={`absolute left-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 ${activeDropdown === 'publications' ? 'block' : 'hidden'}`}>
                <a href="#publications" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Featured</a>
        ...
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          ...
          <div className="relative">
            ...
            <div className={`${activeDropdown === 'publications-mobile' ? 'block' : 'hidden'} pl-4`}>
              <a href="#publications" className="block px-3 py-2 text-gray-700 hover:bg-gray-100">Featured</a>
